...
Rutkauskas, L. (2026). *PDF Markdown Studio* (Version 1.1.2) [Computer software].
...
Release 1.1.3 adds a native Linux ARM64 `.deb`. ARM64 always uses Vulkan,
...
binaries unchanged from release `1.1.2`, verifies their GitHub SHA-256
